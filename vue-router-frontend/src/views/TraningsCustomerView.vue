    ...
    <div class="row">
      ...
      <div class="row row-cols-3 g-3">
        <div  v-for="tr in resultQueryUp(this.trainings)" v-bind:key="tr.id" class="container" style="padding-top: 20px">
          <div class="col">
            <ScheduleTraningCustomer v-if="CheckMe(tr)" :ScheduleTraining = "tr"></ScheduleTraningCustomer>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="row row-cols-3 g-3">
        <div  v-for="tr in resultQueryUp(this.trainingsPassed)" v-bind:key="tr.id" class="container" style="padding-top: 20px">
          <div class="col">
            <ScheduleTraningCustomer @rateFacility="ratefacility" v-if="CheckMe(tr)" :selectedFacilitie="selectedFacilitie" :passed="true" :ScheduleTraining = "tr"></ScheduleTraningCustomer>
          </div>
        </div>
      </div>
    </div>
